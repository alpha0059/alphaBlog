            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                        <span className="font-bold text-lg text-gray-900">alphaBlog</span>
                        <p className="text-sm text-gray-500 mt-1">Share your story with the world.</p>
                    </div>
                    <div className="flex space-x-6">
                        ...
                        <a href="mailto:contact@alphablog.com" className="text-gray-400 hover:text-primary transition-colors">
                ...
                <div className="mt-8 border-t border-gray-100 pt-8 text-center">
                    <p className="text-base text-gray-400">&copy; {new Date().getFullYear()} alphaBlog. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
